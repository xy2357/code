  ...
  .:
    dependencies:
      '@napi-rs/canvas':
        ...
        version: 0.1.100
      '@oai/artifact-tool':
        specifier: file:./local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.43.tgz
        version: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.43.tgz
      '@viz-js/viz':
        specifier: 3.25.0
        version: 3.25.0
      docx:
...
packages:
  ...
  '@oai/artifact-tool@file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.43.tgz':
    resolution: {integrity: sha512-ihMVC4SM5x4kg7jFinYZJOA/Kcg+llmmLjfPJN27HcbN59z8Q0ygskyG/MB3tHtlwUX+oO4/cYjDCRpeZ7ephQ==, tarball: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.43.tgz}
    version: 2.8.43
    bundledDependencies:
      - '@oai/embedded-fonts'
      - '@oai/walnut'
